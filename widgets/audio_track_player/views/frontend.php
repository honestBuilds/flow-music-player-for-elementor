...
<div class="flow-audio-track-player" data-track-metadata='<?php echo $track_metadata_json; ?>'>
    <?php if ($featured_image) : ?>
        <div class="flow-audio-track-player-background bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo esc_url($featured_image); ?>');" data-track-metadata='<?php echo $track_metadata_json; ?>'></div>
