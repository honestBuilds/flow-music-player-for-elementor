    ...
    <div class="container mx-auto px-4 py-8 relative z-10">
        <div class="flex flex-col md:flex-row">
            ...
            <div id="cover" class="md:w-2/5 mb-8 md:mb-0 text-center md:sticky md:top-8 md:self-start">
                ...
                <p class="text-gray-400 album-info no-mbe"><?php echo esc_html(ucfirst($playlist_type)) . ' • ' . esc_html($playlist_year); ?></p>
                <p class="text-gray-400 album-stats no-mbe"><?php echo count($tracks_arr) . ' ' . esc_html($count_unit) . ' • ' . esc_html($total_duration); ?></p>
                    ...
                    <?php if (!empty($tracks_arr)): ?>
                        <?php foreach ($tracks_arr as $index => $track): ?>
                            <li class="flex justify-between items-center p-2 hover:bg-gray-800 cursor-pointer"
                                ...
                                data-track-url="<?php echo esc_url($track['track_file']); ?>"
                                ...
                                <div class="track-info">
                                    ...
                                    <?php endif; ?>
                                    <span class="ml-4 track-title"><?php echo esc_html($track['track_title']); ?></span>
                                </div>
